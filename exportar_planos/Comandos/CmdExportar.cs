...
namespace Riga.ExportarPlanos.Comandos
{
    ...
    public class CmdExportar : IExternalCommand
    {
        public Result Execute(ExternalCommandData datos, ref string mensaje, ElementSet elementos)
        {
            ...
            {
                // Un mensaje suelto ("Object reference not set...") no alcanza para saber
                // donde fallo: dejamos el stack completo en un archivo.
                mensaje = Volcar(ex);
                return Result.Failed;
            }
        }
